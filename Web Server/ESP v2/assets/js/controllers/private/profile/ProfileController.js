...
$scope.saveAdmin = function(id, change){
    ...
    $http.put(theRoute, {
      ...
      .then(function onSuccess(sailsResponse) {
        toastr.success('Thông tin đã được lưu!','', { timeOut: 1000 });
      })
      .catch(function onError(sailsResponse) {
        $scope.editProfile.errorMsg = 'Xuất hiện lỗi: ' + (sailsResponse.data || sailsResponse.status);
  ...
  $scope.saveBanned = function(id, change){
    ...
    $http.put(theRoute, {
      ...
      .then(function onSuccess(sailsResponse) {
        toastr.success('Thông tin đã được lưu!','success', { timeOut: 1000 });
      })
      .catch(function onError(sailsResponse) {
        $scope.editProfile.errorMsg = 'Xuất hiện lỗi: ' + (sailsResponse.data || sailsResponse.status);
      })
 ...
 $scope.changeMyPassword = function() {
    ...
    $http.put('/user/change-password', {
      ...
      .catch(function onError(sailsResponse) {
        ...
        $scope.editProfile.changePassword.errorMsg = 'Xuất hiện lỗi: ' + (sailsResponse.data || sailsResponse.status);
