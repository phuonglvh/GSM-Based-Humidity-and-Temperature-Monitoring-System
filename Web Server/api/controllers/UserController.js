...
module.exports = {
  ...
  /*L O G I N - ACTION*/
    ...
    //debug
    console.log('> enter user/login action! \n');
    for(var key in req.body) {
      if(req.body.hasOwnProperty(key)){
        var array = req.param(key).split(",");
      console.log('> login debug:' + key);
      }
    }
    User.findOne({
        or: [{
      ...
      Passwords.checkPassword({
        ...
        success: function() {
          ...
          if (createdUser.deleted) {
            return res.forbidden("'Your our account has been deleted.  Please contact your admin to restore your account.'");
          }

          if (createdUser.banned) {
            return res.forbidden("'Your our account has been banned, violation of the Terms of Service.'");
          }
  ...
  logout: function(req, res) {
    ...
    User.findOne(req.session.userId, function foundUser(err, foundUser) {
      ...
      //debug
      console.log('debug UserController.logout: 73: ' + foundUser.username);
      return res.ok();
    });
  },
  ...
  adminUsers: function(req, res) {
    //debug
    console.log('UserController/adminUsers\n');
  ...
  changePassword: function(req, res) {
    ...
    Passwords.encryptPassword({
      ...
      success: function(result) {
        ...
        //debug
        console.log('debug: changePassword ' + req.session.userId + ' : '+ result);
        //end debug
